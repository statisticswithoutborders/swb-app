    ...
    render() {
        ...
        return (
            <div>
                ...
                <p class="intro-services">We work to improve decision making and knowledge in efforts that promote welfare through the proper
                    application of statistical principles and best practices, where access to such resources is limited.</p>
                ...
                <hr className="services-hr" />
                <h1 className="title-services">Faunalytics: Working with Statistics Without Borders</h1>
                ...
                <p className="clients">Oranizations that have used our pro-bono services</p>
                ...
                <div className="services-form">
                    <div><FormContact help formCallback={this.handleSend} /></div>
                </div>
            </div >
        )
    }
