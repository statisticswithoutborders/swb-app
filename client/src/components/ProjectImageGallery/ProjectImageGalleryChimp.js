...
class ProjectImageGalleryChimp extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    return (
      <div className="pictureGalleryDiv">
        <div className="pPageImgOne chimpOne"></div>
        <div className="pPageImgTwo chimpTwo"></div>
        <div className="pPageImgThree chimpThree"></div>
...
export default ProjectImageGalleryChimp;