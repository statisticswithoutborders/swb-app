...
class ProjectImageGallerySyria extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    return (
      <div className="pictureGalleryDiv">
        <div className="pPageImgOne syriaOne"></div>
        <div className="pPageImgTwo syriaTwo"></div>
        <div className="pPageImgThree syriaThree"></div>
...
export default ProjectImageGallerySyria;
