...
class ProjectImageGalleryHaiti extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    return (
      <div className="pictureGalleryDiv">
        <div className="pPageImgOne haitiOne"></div>
        <div className="pPageImgTwo haitiTwo"></div>
        <div className="pPageImgThree haitiThree"></div>
...
export default ProjectImageGalleryHaiti;
