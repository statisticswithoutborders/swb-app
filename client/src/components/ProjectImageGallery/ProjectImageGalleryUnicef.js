...
class ProjectImageGalleryUnicef extends Component {
  constructor() {
    super();
    this.state = {};
  }
  ...
  render() {
    return (
      <div className="pictureGalleryDiv">
        <div className="pPageImgOne unicefOne"></div>
        <div className="pPageImgTwo unicefTwo"></div>
        <div className="pPageImgThree unicefThree"></div>
...
export default ProjectImageGalleryUnicef;
